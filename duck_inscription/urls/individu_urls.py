...
from duck_inscription.views import DispatchIndividu, CodeEtuManquant, test_username

urlpatterns = patterns('',
                       url(r'^$', login_required(DispatchIndividu.as_view()), name="dispatch"),
                       url(r'^premiere_connexion/$',
                           CodeEtuManquant.as_view(
...
#                        url(r'^info_perso/$', user_verif_etape_and_login(InfoPersoView.as_view()), name="info_perso"),
#                        url(r'^not_inscrit_p8/$', not_inscrit_p8, name="not_inscrit_p8"),
