...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'duck_inscription_notemastermodel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('moyenne_general', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('note_memoire', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('note_stage', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('wish', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['duck_inscription.Wish'], unique=True)),
        ))
        db.send_create_signal('duck_inscription', ['NoteMasterModel'])

        # Adding field 'SettingsEtape.note_maste'
        db.add_column(u'duck_inscription_settingsetape', 'note_maste',
