...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WishTransitionLog'
        db.create_table(u'duck_inscription_wishtransitionlog', (
            ...
            ('wish', self.gf('django.db.models.fields.related.ForeignKey')(related_name='etape_dossier', to=orm['duck_inscription.Wish'])),
        ))
        db.send_create_signal('duck_inscription', ['WishTransitionLog'])

        # Adding model 'NoteMasterModel'


        # Adding field 'SettingsEtape.note_maste'
    ...
    def backwards(self, orm):
        # Deleting model 'WishTransitionLog'
        db.delete_table(u'duck_inscription_wishtransitionlog')

        # Deleting model 'NoteMasterModel'
        db.delete_table(u'duck_inscription_notemastermodel')

        # Deleting field 'SettingsEtape.note_maste'
        db.delete_column(u'duck_inscription_settingsetape', 'note_maste')


        # Changing field 'Wish.state'
        db.alter_column(u'duck_inscription_wish', 'state', self.gf(u'django_xworkflows.models.StateField')(max_length=21, workflow=__import__('xworkflows', globals(), locals()).base.WorkflowMeta('WishWorkflow', (), {'states': (('creation', 'creation'), ('ouverture_equivalence', 'ouverture_equivalence'), ('liste_diplome', 'liste_diplome'), ('demande_equivalence', 'demande_equivalence'), ('equivalence', 'equivalence'), ('ouverture_candidature', 'ouverture_candidature'), ('ouverture_inscription', 'ouverture_inscription')), 'initial_state': 'creation'})))
