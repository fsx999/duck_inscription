...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SettingAnneeUni.tarif_secu'
        db.add_column(u'duck_inscription_settinganneeuni', 'tarif_secu',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SettingAnneeUni.tarif_secu'
        db.delete_column(u'duck_inscription_settinganneeuni', 'tarif_secu')
