...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SettingsEtape.limite_etu'
        db.add_column(u'duck_inscription_settingsetape', 'limite_etu',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Wish.is_ok'
        db.add_column(u'duck_inscription_wish', 'is_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Wish.date_liste_inscription'
        db.add_column(u'duck_inscription_wish', 'date_liste_inscription',
    ...
    def backwards(self, orm):
        # Deleting field 'SettingsEtape.limite_etu'
        db.delete_column(u'duck_inscription_settingsetape', 'limite_etu')

        # Deleting field 'Wish.is_ok'
        db.delete_column(u'duck_inscription_wish', 'is_ok')

        # Deleting field 'Wish.date_liste_inscription'
        db.delete_column(u'duck_inscription_wish', 'date_liste_inscription')
