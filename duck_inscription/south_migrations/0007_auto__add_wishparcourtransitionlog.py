...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WishParcourTransitionLog'
        db.create_table(u'duck_inscription_wishparcourtransitionlog', (
            ...
            ('wish', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parcours_dossier', to=orm['duck_inscription.Wish'])),
        ))
        db.send_create_signal('duck_inscription', ['WishParcourTransitionLog'])


    def backwards(self, orm):
        # Deleting model 'WishParcourTransitionLog'
        db.delete_table(u'duck_inscription_wishparcourtransitionlog')
