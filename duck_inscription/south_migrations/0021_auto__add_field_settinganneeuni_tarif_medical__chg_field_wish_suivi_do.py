...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SettingAnneeUni.tarif_medical'
        db.add_column(u'duck_inscription_settinganneeuni', 'tarif_medical',
    ...
    def backwards(self, orm):
        # Deleting field 'SettingAnneeUni.tarif_medical'
        db.delete_column(u'duck_inscription_settinganneeuni', 'tarif_medical')
