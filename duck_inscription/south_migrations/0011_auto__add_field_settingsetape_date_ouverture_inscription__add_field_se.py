...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SettingsEtape.date_ouverture_inscription'
        db.add_column(u'duck_inscription_settingsetape', 'date_ouverture_inscription',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SettingsEtape.date_fermeture_inscription'
        db.add_column(u'duck_inscription_settingsetape', 'date_fermeture_inscription',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SettingsEtape.date_fermeture_reinscription'
        db.add_column(u'duck_inscription_settingsetape', 'date_fermeture_reinscription',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SettingsEtape.date_ouverture_inscription'
        db.delete_column(u'duck_inscription_settingsetape', 'date_ouverture_inscription')

        # Deleting field 'SettingsEtape.date_fermeture_inscription'
        db.delete_column(u'duck_inscription_settingsetape', 'date_fermeture_inscription')

        # Deleting field 'SettingsEtape.date_fermeture_reinscription'
        db.delete_column(u'duck_inscription_settingsetape', 'date_fermeture_reinscription')
