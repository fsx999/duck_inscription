...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SettingAnneeUni'
        db.create_table(u'duck_inscription_settinganneeuni', (
        ...
        db.send_create_signal(u'duck_inscription', ['SettingAnneeUni'])

        # Adding model 'SettingsEtape'
        db.create_table(u'duck_inscription_settingsetape', (
            ...
            ('label', self.gf('django.db.models.fields.CharField')(max_length=120, null=True)),
            ('diplome', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['duck_inscription.DiplomeEtape'], null=True, blank=True)),
            ('required_equivalence', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('date_ouverture_equivalence', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('date_fermeture_equivalence', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('date_ouverture_candidature', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('date_fermeture_candidature', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('label_formation', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('annee', self.gf('django.db.models.fields.related.ForeignKey')(default=2014, to=orm['duck_inscription.SettingAnneeUni'])),
            ('document_equivalence', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('document_candidature', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'duck_inscription', ['SettingsEtape'])

        # Adding model 'DiplomeEtape'
        db.create_table(u'duck_inscription_diplomeetape', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=120, null=True)),
        ))
        db.send_create_signal(u'duck_inscription', ['DiplomeEtape'])

        # Adding model 'Individu'
        db.create_table(u'duck_inscription_individu', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('state', self.gf(u'django_xworkflows.models.StateField')(default=u'first_connection', max_length=17, workflow=__import__('xworkflows', globals(), locals()).base.WorkflowMeta('IndividuWorkflow', (), {'states': (('first_connection', 'first_connection'), ('code_etu_manquant', 'code_etu_manquant'), ('individu', 'individu'), ('adresse', 'adresse'), ('recap', 'recap'), ('accueil', 'accueil')), 'initial_state': 'first_connection'}))),
            ('code_opi', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True)),
            ...
            ('common_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('first_name1', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('first_name2', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('first_name3', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('student_code', self.gf('django.db.models.fields.IntegerField')(default=None, max_length=8, null=True, blank=True)),
            ('personal_email', self.gf('django.db.models.fields.EmailField')(max_length=75, unique=True, null=True)),
            ('personal_email_save', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('date_registration_current_year', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ...
            ('code_pays_birth', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name=u'pays_naissance', null=True, to=orm['django_apogee.Pays'])),
            ('code_departement_birth', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.Departement'], null=True, blank=True)),
            ('town_birth', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('code_pays_nationality', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'nationnalite', null=True, to=orm['django_apogee.Pays'])),
            ('valid_ine', self.gf('django.db.models.fields.CharField')(default=u'O', max_length=1, null=None)),
            ('ine', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True)),
            ('family_status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.SitFam'], null=True)),
            ('situation_militaire', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.SitMil'], null=True, blank=True)),
            ('type_handicap', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.TypHandicap'], null=True, blank=True)),
            ('type_hebergement_annuel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.TypHebergement'], null=True, blank=True)),
            ('diplome_acces', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.BacOuxEqu'], null=True, blank=True)),
            ('annee_obtention', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('opi_save', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('year', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.AnneeUni'], null=True, blank=True)),
        ))
        db.send_create_signal(u'duck_inscription', ['Individu'])

        # Adding model 'AdresseIndividu'
        db.create_table(u'duck_inscription_adresseindividu', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('listed_number', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('individu', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'adresses', to=orm['duck_inscription.Individu'])),
            ('code_pays', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.Pays'])),
            ('label_adr_1', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('label_adr_2', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('label_adr_3', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('com_bdi', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.ComBdi'], null=True, blank=True)),
            ('label_adr_etr', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'duck_inscription', ['AdresseIndividu'])

        # Adding model 'Wish'
        db.create_table(u'duck_inscription_wish', (
            ('code_dossier', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('individu', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wishes', null=True, to=orm['duck_inscription.Individu'])),
            ('etape', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['duck_inscription.SettingsEtape'], null=True)),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('valide', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('diplome_acces', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='diplome_acces', null=True, blank=True, to=orm['duck_inscription.ListeDiplomeAces'])),
            ('annee', self.gf('django.db.models.fields.related.ForeignKey')(default=2014, to=orm['duck_inscription.SettingAnneeUni'], db_column='annee')),
            ('centre_gestion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.CentreGestion'], null=True, blank=True)),
            ('is_reins', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True)),
            ('date_validation', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('state', self.gf(u'django_xworkflows.models.StateField')(default=u'creation', max_length=21, workflow=__import__('xworkflows', globals(), locals()).base.WorkflowMeta('WishWorkflow', (), {'states': (('creation', 'creation'), ('ouverture_equivalence', 'ouverture_equivalence'), ('liste_diplome', 'liste_diplome'), ('demande_equivalence', 'demande_equivalence'), ('equivalence', 'equivalence'), ('ouverture_candidature', 'ouverture_candidature'), ('ouverture_inscription', 'ouverture_inscription')), 'initial_state': 'creation'}))),
        ))
        db.send_create_signal('duck_inscription', ['Wish'])

        # Adding model 'ListeDiplomeAces'
        db.create_table(u'pal_liste_diplome_aces', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('etape', self.gf('django.db.models.fields.related.ForeignKey')(related_name='diplome_aces', null=True, to=orm['duck_inscription.SettingsEtape'])),
        ))
        db.send_create_signal('duck_inscription', ['ListeDiplomeAces'])


    def backwards(self, orm):
        # Deleting model 'SettingAnneeUni'
        db.delete_table(u'duck_inscription_settinganneeuni')

        # Deleting model 'SettingsEtape'
        db.delete_table(u'duck_inscription_settingsetape')

        # Deleting model 'DiplomeEtape'
        db.delete_table(u'duck_inscription_diplomeetape')

        # Deleting model 'Individu'
        db.delete_table(u'duck_inscription_individu')

        # Deleting model 'AdresseIndividu'
        db.delete_table(u'duck_inscription_adresseindividu')

        # Deleting model 'Wish'
        db.delete_table(u'duck_inscription_wish')

        # Deleting model 'ListeDiplomeAces'
        db.delete_table(u'pal_liste_diplome_aces')
    ...
    models = {
        ...
        'duck_inscription.wish': {
            ...
            'state': (u'django_xworkflows.models.StateField', [], {'default': "u'creation'", 'max_length': '21', u'workflow': u"__import__('xworkflows', globals(), locals()).base.WorkflowMeta('WishWorkflow', (), {'states': (('creation', 'creation'), ('ouverture_equivalence', 'ouverture_equivalence'), ('liste_diplome', 'liste_diplome'), ('demande_equivalence', 'demande_equivalence'), ('equivalence', 'equivalence'), ('ouverture_candidature', 'ouverture_candidature'), ('ouverture_inscription', 'ouverture_inscription')), 'initial_state': 'creation'})"}),
