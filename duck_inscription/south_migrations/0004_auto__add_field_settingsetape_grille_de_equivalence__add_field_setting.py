...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SettingsEtape.grille_de_equivalence'
        db.add_column(u'duck_inscription_settingsetape', 'grille_de_equivalence',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SettingsEtape.template_name_equivalence'
        db.add_column(u'duck_inscription_settingsetape', 'template_name_equivalence',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SettingsEtape.grille_de_equivalence'
        db.delete_column(u'duck_inscription_settingsetape', 'grille_de_equivalence')

        # Deleting field 'SettingsEtape.template_name_equivalence'
        db.delete_column(u'duck_inscription_settingsetape', 'template_name_equivalence')
    ...
    models = {
        ...
        u'duck_inscription.settingsetape': {
            ...
            'template_name_equivalence': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'})
        },
