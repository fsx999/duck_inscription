...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SettingsEtape.is_inscription_ouverte'
        db.add_column(u'duck_inscription_settingsetape', 'is_inscription_ouverte',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'DiplomeEtape.is_inscription_ouverte'
        db.add_column(u'duck_inscription_diplomeetape', 'is_inscription_ouverte',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SettingsEtape.is_inscription_ouverte'
        db.delete_column(u'duck_inscription_settingsetape', 'is_inscription_ouverte')

        # Deleting field 'DiplomeEtape.is_inscription_ouverte'
        db.delete_column(u'duck_inscription_diplomeetape', 'is_inscription_ouverte')
