...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field property on 'SettingsUser'
        m2m_table_name = db.shorten_name(u'duck_inscription_settingsuser_property')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('settingsuser', models.ForeignKey(orm[u'duck_inscription.settingsuser'], null=False)),
            ('property', models.ForeignKey(orm[u'duck_utils.property'], null=False))
        ))
        db.create_unique(m2m_table_name, ['settingsuser_id', 'property_id'])


        # Changing field 'Wish.suivi_dossier'
        db.alter_column(u'duck_inscription_wish', 'suivi_dossier', self.gf(u'django_xworkflows.models.StateField')(max_length=21, workflow=__import__('xworkflows', globals(), locals()).base.WorkflowMeta('SuiviDossierWorkflow', (), {'states': (('inactif', 'inactif'), ('equivalence_reception', 'equivalence_reception'), ('equivalence_complet', 'equivalence_complet'), ('equivalence_incomplet', 'equivalence_incomplet'), ('equivalence_traite', 'equivalence_traite'), ('equivalence_refuse', 'equivalence_refuse'), ('candidature_reception', 'candidature_reception'), ('candidature_complet', 'candidature_complet'), ('candidature_incomplet', 'candidature_incomplet'), ('candidature_traite', 'candidature_traite'), ('candidature_refuse', 'candidature_refuse'), ('inscription_reception', 'inscription_reception'), ('inscription_complet', 'inscription_complet'), ('inscription_incomplet', 'inscription_incomplet'), ('inscription_incom_r', 'inscription_incom_r'), ('inscription_traite', 'inscription_traite'), ('inscription_refuse', 'inscription_refuse'), ('inscription_annule', 'inscription_annule')), 'initial_state': 'inactif'})))

        # Changing field 'Wish.state'
        db.alter_column(u'duck_inscription_wish', 'state', self.gf(u'django_xworkflows.models.StateField')(max_length=25, workflow=__import__('xworkflows', globals(), locals()).base.WorkflowMeta('WishWorkflow', (), {'states': (('creation', 'creation'), ('ouverture_equivalence', 'ouverture_equivalence'), ('liste_diplome', 'liste_diplome'), ('demande_equivalence', 'demande_equivalence'), ('equivalence', 'equivalence'), ('liste_attente_equivalence', 'liste_attente_equivalence'), ('ouverture_candidature', 'ouverture_candidature'), ('note_master', 'note_master'), ('candidature', 'candidature'), ('liste_attente_candidature', 'liste_attente_candidature'), ('ouverture_inscription', 'ouverture_inscription'), ('dossier_inscription', 'dossier_inscription'), ('choix_ied_fp', 'choix_ied_fp'), ('droit_univ', 'droit_univ'), ('inscription', 'inscription'), ('liste_attente_inscription', 'liste_attente_inscription'), ('auditeur', 'auditeur'), ('auditeur_traite', 'auditeur_traite')), 'initial_state': 'creation'})))

        # Changing field 'Wish.annee'
        db.alter_column(u'duck_inscription_wish', u'annee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['duck_inscription.SettingAnneeUni'], db_column=u'annee'))

    def backwards(self, orm):
        # Removing M2M table for field property on 'SettingsUser'
        db.delete_table(db.shorten_name(u'duck_inscription_settingsuser_property'))


        # Changing field 'Wish.suivi_dossier'
        db.alter_column(u'duck_inscription_wish', 'suivi_dossier', self.gf(u'django_xworkflows.models.StateField')(max_length=21, workflow=__import__('xworkflows', globals(), locals()).base.WorkflowMeta('SuiviDossierWorkflow', (), {'states': (('inactif', 'inactif'), ('equivalence_reception', 'equivalence_reception'), ('equivalence_complet', 'equivalence_complet'), ('equivalence_incomplet', 'equivalence_incomplet'), ('equivalence_traite', 'equivalence_traite'), ('equivalence_refuse', 'equivalence_refuse'), ('candidature_reception', 'candidature_reception'), ('candidature_complet', 'candidature_complet'), ('candidature_incomplet', 'candidature_incomplet'), ('candidature_traite', 'candidature_traite'), ('candidature_refuse', 'candidature_refuse'), ('inscription_reception', 'inscription_reception'), ('inscription_complet', 'inscription_complet'), ('inscription_incomplet', 'inscription_incomplet'), ('inscription_incom_r', 'inscription_incom_r'), ('inscription_traite', 'inscription_traite'), ('inscription_refuse', 'inscription_refuse')), 'initial_state': 'inactif'})))

        # Changing field 'Wish.state'
        db.alter_column(u'duck_inscription_wish', 'state', self.gf(u'django_xworkflows.models.StateField')(max_length=25, workflow=__import__('xworkflows', globals(), locals()).base.WorkflowMeta('WishWorkflow', (), {'states': (('creation', 'creation'), ('ouverture_equivalence', 'ouverture_equivalence'), ('liste_diplome', 'liste_diplome'), ('demande_equivalence', 'demande_equivalence'), ('equivalence', 'equivalence'), ('liste_attente_equivalence', 'liste_attente_equivalence'), ('ouverture_candidature', 'ouverture_candidature'), ('note_master', 'note_master'), ('candidature', 'candidature'), ('liste_attente_candidature', 'liste_attente_candidature'), ('ouverture_inscription', 'ouverture_inscription'), ('dossier_inscription', 'dossier_inscription'), ('choix_ied_fp', 'choix_ied_fp'), ('droit_univ', 'droit_univ'), ('inscription', 'inscription'), ('liste_attente_inscription', 'liste_attente_inscription')), 'initial_state': 'creation'})))

        # Changing field 'Wish.annee'
        db.alter_column(u'duck_inscription_wish', 'annee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['duck_inscription.SettingAnneeUni'], db_column='annee'))
    ...
    models = {
        ...
        u'duck_inscription.individutransitionlog': {
            'Meta': {'object_name': 'IndividuTransitionLog'},
            'from_state': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'individu': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'etape_dossier'", 'to': u"orm['duck_inscription.Individu']"}),
        ...
        u'duck_inscription.listediplomeaces': {
            'Meta': {'object_name': 'ListeDiplomeAces', 'db_table': "u'pal_liste_diplome_aces'"},
            'etape': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'diplome_aces'", 'null': 'True', 'to': u"orm['duck_inscription.SettingsEtape']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'duck_inscription.moyenpaiementmodel': {
        ...
        u'duck_inscription.notemastermodel': {
            ...
            'wish': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['duck_inscription.Wish']", 'unique': 'True'})
        },
        u'duck_inscription.paiementallmodel': {
            'Meta': {'object_name': 'PaiementAllModel'},
            'demi_annee': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'etape': ('django.db.models.fields.CharField', [], {'default': "u'droit_univ'", 'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'moyen_paiement': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['duck_inscription.MoyenPaiementModel']", 'null': 'True'}),
        ...
        u'duck_inscription.settinganneeuni': {
            ...
            'bourse_pdf': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'inscription': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'pieces_pdf': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'tarif_medical': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'tarif_secu': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'transfert_pdf': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        u'duck_inscription.settingsetape': {
            ...
            'limite_etu': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'duck_inscription.settingsuser': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'property': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['duck_utils.Property']", 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "u'setting_user'", 'unique': 'True', 'to': u"orm['auth.User']"})
        },
        u'duck_inscription.typepaiementmodel': {
        ...
        u'duck_inscription.wish': {
            'Meta': {'object_name': 'Wish'},
            'annee': ('django.db.models.fields.related.ForeignKey', [], {'default': '2014', 'to': u"orm['duck_inscription.SettingAnneeUni']", 'db_column': "u'annee'"}),
            'centre_gestion': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['duck_inscription.CentreGestionModel']", 'null': 'True', 'blank': 'True'}),
            'code_dossier': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_liste_inscription': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_validation': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'demi_annee': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'diplome_acces': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'diplome_acces'", 'null': 'True', 'blank': 'True', 'to': u"orm['duck_inscription.ListeDiplomeAces']"}),
            'etape': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['duck_inscription.SettingsEtape']", 'null': 'True'}),
            'individu': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'wishes'", 'null': 'True', 'to': u"orm['duck_inscription.Individu']"}),
            'is_auditeur': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'state': (u'django_xworkflows.models.StateField', [], {'default': "u'creation'", 'max_length': '25', u'workflow': u"__import__('xworkflows', globals(), locals()).base.WorkflowMeta('WishWorkflow', (), {'states': (('creation', 'creation'), ('ouverture_equivalence', 'ouverture_equivalence'), ('liste_diplome', 'liste_diplome'), ('demande_equivalence', 'demande_equivalence'), ('equivalence', 'equivalence'), ('liste_attente_equivalence', 'liste_attente_equivalence'), ('ouverture_candidature', 'ouverture_candidature'), ('note_master', 'note_master'), ('candidature', 'candidature'), ('liste_attente_candidature', 'liste_attente_candidature'), ('ouverture_inscription', 'ouverture_inscription'), ('dossier_inscription', 'dossier_inscription'), ('choix_ied_fp', 'choix_ied_fp'), ('droit_univ', 'droit_univ'), ('inscription', 'inscription'), ('liste_attente_inscription', 'liste_attente_inscription'), ('auditeur', 'auditeur'), ('auditeur_traite', 'auditeur_traite')), 'initial_state': 'creation'})"}),
            'suivi_dossier': (u'django_xworkflows.models.StateField', [], {'default': "u'inactif'", 'max_length': '21', u'workflow': u"__import__('xworkflows', globals(), locals()).base.WorkflowMeta('SuiviDossierWorkflow', (), {'states': (('inactif', 'inactif'), ('equivalence_reception', 'equivalence_reception'), ('equivalence_complet', 'equivalence_complet'), ('equivalence_incomplet', 'equivalence_incomplet'), ('equivalence_traite', 'equivalence_traite'), ('equivalence_refuse', 'equivalence_refuse'), ('candidature_reception', 'candidature_reception'), ('candidature_complet', 'candidature_complet'), ('candidature_incomplet', 'candidature_incomplet'), ('candidature_traite', 'candidature_traite'), ('candidature_refuse', 'candidature_refuse'), ('inscription_reception', 'inscription_reception'), ('inscription_complet', 'inscription_complet'), ('inscription_incomplet', 'inscription_incomplet'), ('inscription_incom_r', 'inscription_incom_r'), ('inscription_traite', 'inscription_traite'), ('inscription_refuse', 'inscription_refuse'), ('inscription_annule', 'inscription_annule')), 'initial_state': 'inactif'})"}),
            'valide': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'duck_inscription.wishparcourtransitionlog': {
            ...
            'to_state': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'transition': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'wish': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'parcours_dossier'", 'to': u"orm['duck_inscription.Wish']"})
        },
        u'duck_inscription.wishtransitionlog': {
            ...
            'to_state': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'transition': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'wish': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'etape_dossier'", 'to': u"orm['duck_inscription.Wish']"})
        },
