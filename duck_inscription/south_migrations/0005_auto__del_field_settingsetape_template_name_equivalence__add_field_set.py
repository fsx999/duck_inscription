...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SettingsEtape.path_template_equivalence'
        db.add_column(u'duck_inscription_settingsetape', 'path_template_equivalence',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SettingsEtape.path_template_equivalence'
        db.delete_column(u'duck_inscription_settingsetape', 'path_template_equivalence')
