...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SettingAnneeUni.transfert_pdf'
        db.add_column(u'duck_inscription_settinganneeuni', 'transfert_pdf',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SettingAnneeUni.bourse_pdf'
        db.add_column(u'duck_inscription_settinganneeuni', 'bourse_pdf',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SettingAnneeUni.pieces_pdf'
        db.add_column(u'duck_inscription_settinganneeuni', 'pieces_pdf',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SettingAnneeUni.transfert_pdf'
        db.delete_column(u'duck_inscription_settinganneeuni', 'transfert_pdf')

        # Deleting field 'SettingAnneeUni.bourse_pdf'
        db.delete_column(u'duck_inscription_settinganneeuni', 'bourse_pdf')

        # Deleting field 'SettingAnneeUni.pieces_pdf'
        db.delete_column(u'duck_inscription_settinganneeuni', 'pieces_pdf')
