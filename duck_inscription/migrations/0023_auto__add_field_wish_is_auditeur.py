...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wish.is_auditeur'
        db.add_column(u'duck_inscription_wish', 'is_auditeur',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wish.is_auditeur'
        db.delete_column(u'duck_inscription_wish', 'is_auditeur')
