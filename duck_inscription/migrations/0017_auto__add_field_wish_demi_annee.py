...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wish.demi_annee'
        db.add_column(u'duck_inscription_wish', 'demi_annee',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wish.demi_annee'
        db.delete_column(u'duck_inscription_wish', 'demi_annee')
