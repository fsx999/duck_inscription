...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DossierInscription'
        db.create_table(u'duck_inscription_dossierinscription', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('individu', self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'dossier_inscription', unique=True, to=orm['duck_inscription.Individu'])),
            ('annee_premiere_inscription_p8', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('annee_premiere_inscription_enseignement_sup_fr', self.gf('django.db.models.fields.CharField')(max_length=4, null=True)),
            ('annee_premiere_inscription_universite_fr', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('premier_universite_fr', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name=u'premiere_universite_fr', null=True, blank=True, to=orm['django_apogee.Etablissement'])),
            ('bac', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.BacOuxEqu'], null=True, blank=True)),
            ('annee_bac', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('mention_bac', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.MentionBac'], null=True)),
            ('etablissement_bac', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'etablissement_bac', null=True, to=orm['django_apogee.Etablissement'])),
            ('annee_dernier_etablissement', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('annee_derniere_inscription_universite_hors_p8', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('dernier_etablissement', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'dernier_etablissement', null=True, to=orm['django_apogee.Etablissement'])),
            ('sise_annee_precedente', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.SituationSise'], null=True)),
            ('etablissement_annee_precedente', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'etablissement_annee_precedente', null=True, to=orm['django_apogee.Etablissement'])),
            ('type_dernier_diplome', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.TypeDiplomeExt'], null=True)),
            ('annee_dernier_diplome', self.gf('django.db.models.fields.CharField')(max_length=4, null=True)),
            ('etablissement_dernier_diplome', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'etablissement_dernier_diplome', null=True, to=orm['django_apogee.Etablissement'])),
            ('autre_eta', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('autre_etablissement', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'autre_etablissement', null=True, to=orm['django_apogee.Etablissement'])),
            ('cat_soc_etu', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'cat_soc_etu', null=True, to=orm['django_apogee.CatSocPfl'])),
            ('cat_soc_chef_famille', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'cat_soc_chef_famille', null=True, to=orm['django_apogee.CatSocPfl'])),
            ('cat_soc_autre_parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'cat_soc_autre_parent', null=True, to=orm['django_apogee.CatSocPfl'])),
            ('sportif_haut_niveau', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('quotite_travail', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.QuotiteTra'], null=True, blank=True)),
            ('cat_travail', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.DomaineActPfl'], null=True, blank=True)),
            ('etape', self.gf('django.db.models.fields.CharField')(default=u'scolarite', max_length=20)),
            ('situation_sociale', self.gf('django.db.models.fields.related.ForeignKey')(default=u'NO', related_name=u'situation_sociale_dossier', null=True, blank=True, to=orm['django_apogee.SitSociale'])),
            ('echelon', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
            ('num_boursier', self.gf('django.db.models.fields.CharField')(max_length=13, null=True, blank=True)),
            ('boursier_crous', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True)),
            ('affiliation_parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'affiliation_parent_dossier', null=True, to=orm['django_apogee.RegimeParent'])),
            ('non_affiliation', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'non_affiliation_dossier', null=True, to=orm['django_apogee.MtfNonAflSso'])),
            ('centre_payeur', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True)),
            ('num_secu', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
        ))
        db.send_create_signal(u'duck_inscription', ['DossierInscription'])


    def backwards(self, orm):
        # Deleting model 'DossierInscription'
        db.delete_table(u'duck_inscription_dossierinscription')
