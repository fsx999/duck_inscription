...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IndividuTransitionLog'
        db.create_table(u'duck_inscription_individutransitionlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('transition', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('from_state', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('to_state', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True)),
            ('individu', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'etape_dossier', to=orm['duck_inscription.Individu'])),
        ))
        db.send_create_signal(u'duck_inscription', ['IndividuTransitionLog'])


    def backwards(self, orm):
        # Deleting model 'IndividuTransitionLog'
        db.delete_table(u'duck_inscription_individutransitionlog')
