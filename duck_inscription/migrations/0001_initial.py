    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_code', models.IntegerField(default=None, max_length=8, null=True, verbose_name='Code \xe9tudiant', blank=True)),
                ('personal_email', models.EmailField(max_length=75, unique=True, null=True, verbose_name='Email')),
                ('personal_email_save', models.EmailField(max_length=75, null=True, verbose_name='Email', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ManyToManyField(to='duck_utils.Property', null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', django_xworkflows.models.StateField(max_length=25, workflow=django_xworkflows.models._SerializedWorkflow(states=[b'creation', b'ouverture_equivalence', b'liste_diplome', b'demande_equivalence', b'equivalence', b'liste_attente_equivalence', b'ouverture_candidature', b'note_master', b'candidature', b'liste_attente_candidature', b'ouverture_inscription', b'dossier_inscription', b'choix_ied_fp', b'droit_univ', b'inscription', b'liste_attente_inscription', b'auditeur', b'auditeur_traite'], initial_state=b'creation', name=b'WishWorkflow'))),
