...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CursusEtape'
        db.create_table(u'duck_inscription_cursusetape', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
        ))
        db.send_create_signal(u'duck_inscription', ['CursusEtape'])

        # Adding field 'SettingsEtape.cursus'
        db.add_column(u'duck_inscription_settingsetape', 'cursus',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['duck_inscription.CursusEtape'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CursusEtape'
        db.delete_table(u'duck_inscription_cursusetape')

        # Deleting field 'SettingsEtape.cursus'
        db.delete_column(u'duck_inscription_settingsetape', 'cursus_id')
