    ...
    transitions = (
        ...
        ('inscription_reception',
         ('inactif', 'equivalence_traite', 'candidature_complet', 'candidature_traite', 'inscription_incomplet',
          'inscription_incom_r'),
         'inscription_reception'),
        ('inscription_incomplet', ('inscription_reception', 'inscription_complet'), 'inscription_incomplet'),
        ('inscription_incomplet_renvoi', ('inscription_reception', 'inscription_complet'), 'inscription_incom_r'),
