...
from duck_inscription.models import SettingAnneeUni, SettingsEtape, Wish, WishTransitionLog
...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        for trans in TransitionLog.objects.filter(content_type=t,transition__in=['equivalence_receptionner']):
            try:
                WishTransitionLog.objects.create(
                ...
                pass
        print WishTransitionLog.objects.all().count()
